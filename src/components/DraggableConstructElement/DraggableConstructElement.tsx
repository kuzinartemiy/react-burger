...
export const DraggableConstructElement = ({ ingredient, handleDeleteIngredient, index }: IDraggableConstructElementProps) => {
  ...
  const [{ isHover }, sortDropRef] = useDrop({
    ...
    hover(item: { index: number }, monitor) {
      ...
      const filteredIngredients = selectedIngredients.filter((el: TIngredientType) => el.customId !== selectedIngredients[dragElementIndex].customId);
